...
public abstract class Button extends CustomView {
	...
	protected void setDefaultProperties() {
		// Min size
		setMinimumHeight(Utilities.dpToPx(minHeight, getResources()));
		setMinimumWidth(Utilities.dpToPx(minWidth, getResources()));
		// Background shape
	...
	public Bitmap makeCircle() {
		Bitmap output = Bitmap.createBitmap(
				getWidth() - Utilities.dpToPx(6, getResources()), getHeight()
						- Utilities.dpToPx(7, getResources()), Config.ARGB_8888);
