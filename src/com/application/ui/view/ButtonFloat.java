...
public class ButtonFloat extends Button {
	...
	public ButtonFloat(Context context, AttributeSet attrs) {
		...
		RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(
				Utilities.dpToPx(sizeIcon, getResources()), Utilities.dpToPx(
						sizeIcon, getResources()));
	...
	protected void setDefaultProperties() {
		rippleSpeed = Utilities.dpToPx(2, getResources());
		rippleSize = Utilities.dpToPx(5, getResources());
		setMinimumWidth(Utilities.dpToPx(sizeRadius * 2, getResources()));
		setMinimumHeight(Utilities.dpToPx(sizeRadius * 2, getResources()));
		...
		post(new Runnable() {
			...
			public void run() {
				showPosition = ViewHelper.getY(ButtonFloat.this)
						- Utilities.dpToPx(24, getResources());
	...
	protected void onDraw(Canvas canvas) {
		...
		if (x != -1) {
			...
			Rect dst = new Rect(Utilities.dpToPx(1, getResources()),
					Utilities.dpToPx(2, getResources()), getWidth()
							- Utilities.dpToPx(1, getResources()), getHeight()
							- Utilities.dpToPx(2, getResources()));
